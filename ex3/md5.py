...
#     msg_lenth = len(list(ascii_list)) * 8
#     list(ascii_list).append('0x80')
#     # print(len(list(ascii_list)))
#     # for rr in ascii_list:
#     #     print(rr)
#     # 补充0
#     print(len(list(ascii_list)),'sss')
#     while (len(list(ascii_list)) * 8 + 64) % 512 != 0:
#         # print('hi')
#         list(ascii_list).append('0x00')
#
#
#     print('bingo')
#
